  ...
  datasets: [
    {
      label: "# of Votes",
      data: [80, 20],
      backgroundColor: ["#F44336", "#B1B1B1"],
      borderColor: ["#F44336", "#B1B1B1"],
      borderWidth: 1,
    },
  ],
};
function StatusCardDanger({ cardData }) {
  return (
    <div>
      <div className="  border-t-2 rounded-md border-t-theme_red-0 shadow-md text-black w-60 py-3 relative text-left px-5 mx-3 my-3">
        <span className="bg-theme_red-0 p-1 text-xs text-white font-bold absolute right-5 mr-5 mt-3 rounded-md">
          {cardData?.Status}
        </span>
